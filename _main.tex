...
\titleformat{\chapter}[hang]{\LARGE}{\color{gray75}\textsc{Chapitre} \thechapter}{14pt}{\begin{tabular}[t]{@{\color{gray75}\hsp}p{0.75\textwidth}}\raggedright\textsc{#1}\end{tabular}}
...
% Ensure correct numbering for conclusion
\clearpage
\phantomsection
\refstepcounter{chapter} % Manually increment to Chapter 5
