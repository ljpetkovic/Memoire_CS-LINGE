...
\textsc{KeyBERT} \citep{grootendorst2023}\footnote{\url{https://maartengr.github.io/KeyBERT/}} et \textsc{Keyphrase-Vectorizers}\footnote{\url{https://pypi.org/project/keyphrase-vectorizers/}}
\begin{figure}[!h]
    \centering
    \includegraphics[width=1\textwidth]{img/keybert.png}
    \caption{\textit{Pipeline} de la librairie \texttt{keybert}.}
    
    \url{https://maartengr.github.io/KeyBERT/guides/quickstart.html#installation}
